...
const productsData = [
  ...
  },
  {
    ...
    gallery: JSON.stringify(["https://images.unsplash.com/photo-1610694955371-d4a3e0ce4b52?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2Nzd8MHwxfHNlYXJjaHwxfHxuZWNrbGFjZXxlbnwwfHx8fDE3NTI3MjA0NjN8MA&ixlib=rb-4.1.0&q=85"]),
    price: 320,
    discount: JSON.stringify({
      amount: 0,
      percentage: 0,
  ...
  },
  {
    ...
    gallery: JSON.stringify(["https://images.pexels.com/photos/1034063/pexels-photo-1034063.jpeg?auto=compress&cs=tinysrgb&w=1000&h=1000&fit=crop"]),
    price: 2400,
    discount: JSON.stringify({
      amount: 0,
      percentage: 0,
  ...
  },
  {
    ...
    gallery: JSON.stringify(["https://images.unsplash.com/photo-1611652022419-a9419f74343d?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2NDJ8MHwxfHNlYXJjaHwyfHxqZXdlbHJ5fGVufDB8fHx8MTc1MjcwODQ2Mnww&ixlib=rb-4.1.0&q=85"]),
    price: 320,
    discount: JSON.stringify({
      amount: 0,
      percentage: 0,
